...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 15, 2023 at 08:44 AM
...
(15, 'action', 'Naruto', 2023, '2023-02-15', '2023-02-28', 10000);
...
(15, 'M.Ikhwan Sholihin', 'Sayung', 15);
...
--
ALTER TABLE `tb_dvd`
  MODIFY `id_dvd` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
